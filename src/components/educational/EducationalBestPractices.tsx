...
export function EducationalBestPractices({ isOpen, onClose }: EducationalBestPracticesProps) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 border border-purple-200/60">
        <div className="p-6">
          <div className="flex items-start justify-between mb-4">
            <h2 className="text-2xl font-bold text-gray-900">Educational Content Best Practices</h2>
            <button
              onClick={onClose}
          ...
          <div className="space-y-6 text-gray-800">
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Structure matters</h3>
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Design for clarity</h3>
              <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Narration tips</h3>
              <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Pacing and timing</h3>
              <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Finish strong</h3>
              <ul className="list-disc pl-5 space-y-1 text-sm">
