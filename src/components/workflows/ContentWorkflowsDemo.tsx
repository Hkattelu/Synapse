...
export function ContentWorkflowsDemo() {
  ...
  const [selectedHelp, setSelectedHelp] = useState<'code' | 'video' | 'assets'>(
    'code'
  );
    ...
    <div className="p-8 bg-gray-900 min-h-screen">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-8">
          Educational Content Addition Workflows
        </h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Create code snippets with templates, syntax highlighting, and
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Add videos with type selection, recording tips, and smart track
                placement.
              </p>
              <button
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Upload and categorize educational assets with smart organization
                and metadata.
              </p>
              <button
