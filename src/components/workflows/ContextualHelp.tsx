...
const HELP_CONTENT: Record<string, HelpContent> = {
  code: {
    ...
    description: 'Create engaging code demonstrations that help learners understand programming concepts effectively.',
    tips: [
  ...
  video: {
    ...
    description: 'Create professional educational videos that engage learners and effectively demonstrate concepts.',
    tips: [
  ...
  assets: {
    ...
    description: 'Select and organize visual and audio assets that enhance learning and support your educational content.',
    tips: [
...
export function ContextualHelp({ type, className = '' }: ContextualHelpProps) {
  const [activeTab, setActiveTab] = useState<'tips' | 'practices' | 'examples'>('tips');
      ...
      <div className="p-4">
        <ul className="space-y-2">
          {(activeTab === 'tips' ? content.tips :
            activeTab === 'practices' ? content.bestPractices :
