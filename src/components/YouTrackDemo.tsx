    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">
          You Track Features Demo
        </h1>
        <p className="text-gray-600">
          Explore the personal video features designed for educational content
          creators. This demo showcases talking head detection,
          picture-in-picture controls, background options, and professional
          templates.
        </p>
      </div>
          ...
          <div className="bg-white rounded-lg border p-4 sticky top-6">
            ...
            <div className="space-y-3 text-sm">
                ...
                <>
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <span className="text-gray-900">
                      {demoItem.properties?.talkingHeadCorner}
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <span className="text-gray-900">
                      {demoItem.properties?.talkingHeadSize}
                    </span>
                  </div>
                </>
              )}
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <span
                  className={
                    demoItem.properties?.backgroundRemoval
                      ? 'text-green-600'
                      : 'text-gray-400'
                  }
                >
              ...
              {demoItem.properties?.backgroundBlur &&
                demoItem.properties.backgroundBlur > 0 && (
                  <div className="grid grid-cols-2 gap-2">
                    <span className="text-gray-600">Background Blur:</span>
                    <span className="text-gray-900">
                      {Math.round(demoItem.properties.backgroundBlur * 100)}%
                    </span>
                  </div>
                )}
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <span className="text-gray-900">
                  {Math.round((demoItem.properties?.volume || 0.8) * 100)}%
                </span>
              </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg border p-4 text-center">
          ...
          <p className="text-sm text-gray-600">
            Automatically detect and optimize personal video content for
        ...
        <div className="bg-white rounded-lg border p-4 text-center">
          ...
          <p className="text-sm text-gray-600">
            Flexible positioning and sizing controls for optimal video
            composition.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg border p-4 text-center">
          ...
          <p className="text-sm text-gray-600">
            Remove, blur, or replace backgrounds for professional-looking
            presentations.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
          <div>
            ...
            <ol className="space-y-2 text-blue-700">
              ...
              <li>
                2. The system will automatically detect talking head content
              </li>
